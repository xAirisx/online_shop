...
ALTER TABLE `product_order` ADD  CONSTRAINT `unique_product_order` UNIQUE (`order_id`,`product_id`);
...
INSERT INTO `user` (`id`, `email`, `password`, `type`, `firstname`, `lastname`, `address`, `contact_info`, `photo`, `status`, `created_on`) VALUES
...
INSERT INTO `product` (`id`, `category_id`, `name`, `description`, `slug`, `price`, `photo`, `date_view`, `views_today`) VALUES
...
INSERT INTO `order` (`id`, `user_id`, `pay_id`, `date`) VALUES
(1, 2, '1', '2018-10-10'),
(2, 3, '2', '2018-10-9');

INSERT INTO `product_order` (`id`, `order_id`, `product_id`, `quantity`) VALUES
(1, 1, 1,1),
(2, 1, 2,1),
(3, 1, 7,2),
(4, 2, 7,2),
